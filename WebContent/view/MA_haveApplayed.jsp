...
<head>
    ...
    <title>MA_haveApplayed</title>
	  <link rel="stylesheet" type="text/css" href="css\\MA_haveApplayed.css">
    <script type="text/javascript" src="../js/jquery-2.1.4.min.js"></script>
    <link  rel="stylesheet" type="text/css" href="../css/setpage.css">
</head>

<body class="body">
 <div class="MA_haveApplayed">
<!--    <div class="buttonBlock">
  	<form class="buttonForm"> -->
      <!-- <input type="button"  value="删除" /> -->
     <!--  style="background:url(images//delete.png); 
      border-style:none;width:85px;height:35px; background-repeat:no-repeat;"  /> -->
<!--     </form>
    <form class="buttonForm">
      <input type="button"  value="刷新" />
      style="background:url(images//button.png); 
      border-style:none;width:85px;height:35px; background-repeat:no-repeat;"  />
    </form > -->
          ...
          if (xmlhttp.readyState==4 && xmlhttp.status==200)
             {
                ...
                for(var i=0;i<applays.length;i++){
                    item+="<tr class='tr'><td width='10%'><input type='checkbox' name='bike' /></td><td width='8%'>"+applays[i].grade+"</td><td width='8%'>"+applays[i].userName+"</td><td width='10%'>"+applays[i].major+"</td><td width='8%'>"+applays[i].groupName+"</td><td width='10%'>"+applays[i].email+"</td><td width='10%'>"+applays[i].mobilePhone+"</td><td width='12%'>"+applays[i].createDate+"</td><td width='8%'>"+applays[i].applayStatus+"</td><td width='8%'><a href='http://www.baidu.com/'>查看</a></td></tr>"
                }
                $(".tableB").prepend(item);
             }
        });
